...
${SIM} -config ${CONFIG_DIR}/4c.cfg -- /home/ubuntu/github/swarm_ecbsllhl_local/source_codes/ecbs_simple_swarm -i ${EXAMPLES}/map_32by32_obst204_agents20_ex1.yaml -o output.yaml -w 1.2
